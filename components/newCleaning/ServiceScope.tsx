...
import { cleaningScope } from "@/app/data/cleaning-details"

export const ServiceScope = () => {
  // Convert object entries to an array for consistent mapping
  const sections = Object.entries(cleaningScope)
    ...
    <section className="mx-auto max-w-7xl py-24">
      <div className="container mx-auto px-6">
        ...
        <div className="space-y-16">
          ...
          {/* BOTTOM ROW: Add-ons Only (Horizontally Aligned) */}
